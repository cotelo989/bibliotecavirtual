 ...
 */
public class EliminarEditorial extends javax.swing.JInternalFrame {
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        try {
            ...
            String query ="delete from editorial where cod_edi = '"+codigo+"'";
            ...
            Logger.getLogger(EliminarEditorial.class.getName()).log(Level.SEVERE, null, ex);
        }
