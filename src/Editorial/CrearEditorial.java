 ...
 */
public class CrearEditorial extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (cod_edi.trim().equals("")||nombre.trim().equals("")) {
                JOptionPane.showMessageDialog(this, "Complete los espacios en blanco");
            }
            try{

                String query = " insert into editorial values ('"+cod_edi+"','"+nombre+"')";
